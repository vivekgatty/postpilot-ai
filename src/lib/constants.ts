...
export const NAV_ITEMS = [
  ...
  { href: '/analyse',           label: 'Post Analyser', icon: 'BarChart2',      proOnly: false },
  { href: '/dashboard/repurpose', label: 'Repurpose', icon: 'RefreshCw',       proOnly: false },
  { href: '/carousel',          label: 'Carousel Creator', icon: 'LayoutTemplate', proOnly: false },
  ...
  { href: '/streak',            label: 'Streak',           icon: 'Flame',          proOnly: false },
  { href: '/dashboard/audit',             label: 'Brand Audit',        icon: 'Target',          proOnly: false },
  { href: '/profile-optimizer',           label: 'Profile Optimizer',  icon: 'Target',          proOnly: false },
